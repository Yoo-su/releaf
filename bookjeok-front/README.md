# 📚 bookjeok: 문화와 지식을 잇는 아카이브

**bookjeok(북적)**은 스쳐 지나가는 문화 예술 정보와 잠들어 있는 중고 서적의 가치를 다시 발견하고 연결하는 웹 플랫폼입니다. 공연, 전시 등 다채로운 문화 예술 정보를 탐색하고, 소장하고 있던 중고 서적을 다른 사람과 쉽고 편리하게 거래하며 지식의 선순환을 만들어보세요.

<br/>

### 🌐 서비스 바로가기 (Service URL)

**[https://bookjeok.com](https://bookjeok.com)**
...
bookjeok은 사용자의 문화 생활과 지식 공유를 돕기 위해 다음과 같은 핵심 기능들을 제공합니다.
...
- **💬 댓글 시스템 (Comment System)**
  - 도서와 리뷰에 댓글을 작성하고 좋아요를 표현할 수 있습니다.
  - 낙관적 업데이트를 적용하여 빠른 인터랙션을 제공합니다.

- **📅 독서 기록 (Reading Log)**
  - 날짜별로 읽은 책을 기록하고 메모를 남길 수 있습니다.
  - 캘린더 뷰로 월별 독서 현황을 시각적으로 확인할 수 있습니다.
  - 월별/연간 독서 통계를 제공합니다.

- **📊 인사이트 대시보드 (Insights Dashboard)**
...
1.  **Repository 클론:**
    ...
    ```bash
    git clone https://github.com/Maeve-Kim/bookjeok.git
    cd bookjeok-front
    ```
