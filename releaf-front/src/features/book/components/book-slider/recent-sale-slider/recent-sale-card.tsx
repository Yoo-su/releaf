    ...
    >
      <div className="flex flex-col items-center text-center py-4">
        ...
        <div className="relative w-40 h-40 mb-4 transition-transform duration-300 ease-in-out group-hover:scale-105">
          <div className="absolute inset-0 rounded-full bg-linear-to-tr from-emerald-100 to-teal-100 transition-all duration-300 group-hover:inset-[-4px]" />
        ...
        <p className="mt-1 text-lg font-extrabold text-transparent bg-clip-text bg-linear-to-r from-emerald-600 to-teal-600">
